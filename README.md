# Xss-Swagger-Api to Account Takeover

- ?configUrl parameter is vulnerable beacuse of that u can call and inject javascript code with yaml file from a json file.
